/* DefaultPufCompletePoolSheetConfiguration.java
 * =========================================================================
 ...
 * @author nvcleemp
 */
public class DefaultPufCompletePoolSheetConfiguration extends DefaultAbstractPoolSheetConfiguration implements PufCompletePoolSheetConfiguration{

    private final int[] teamSizes = new int[2];

    private String[][] playerNames = new String[2][];

    public DefaultPufCompletePoolSheetConfiguration(int nrOfPlayersTeamA, int nrOfPlayersTeamB, float squareCellSize, Image image, Locale locale, String title, String subtitle){
    ...
    public DefaultPufCompletePoolSheetConfiguration(int nrOfPlayersTeamA, int nrOfPlayersTeamB, float squareCellSize, Image image, Locale locale){
    ...
    public BoutOrder getBoutOrder() {
        return PufBoutOrder.getCompleteBoutOrder(teamSizes[0], teamSizes[1]);
    }
